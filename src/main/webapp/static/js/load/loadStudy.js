            ...
            if (series.numberOfFrames !== undefined) {
                ...
                for (var i = 0; i < numberOfFrames; i++) {
                    ...
                    if (imageId.substr(0, 4) !== 'http') {
                    	//图片地址，可以改成自己的地址，后面imageId 是图片私有地址，前面是公共的区间
                        imageId = "dicomweb://localhost:8080/images/" + imageId;
                    }
                ...
                series.instanceList.forEach(function(image) {
                    ...
                    if (image.imageId.substr(0, 4) !== 'http') {
                        imageId = "dicomweb://localhost:8080/webpasc/static/img/" + image.imageId;
                    }
                    stack.imageIds.push(imageId);
                });
            }
